        ...
        <div className="relative perspective-1000">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {images.map((image, index) => {
              ...
              // Add slight downward offset for 2nd image
              const baseOffset = index === 1 ? 47 : 0; // 20px down
                ...
                <div
                  ...
                  style={{
                    ...
                    transform: galleryVisible
                      ? `perspective(500px) rotateY(${direction * 3}deg) translateY(${
                          baseOffset + (scrollY - 2000) * speed * direction
                        }px)`
